...
public class RotationAndColors {
    ...
    public static void main(String[] args) throws DocumentException, IOException {
        ...
        cell.setBackgroundColor(RGBColor.RED);
        table.addCell(cell);
        cell = new PdfPCell(new Phrase("green / black bottom border"));
        cell.setBorder(Rectangle.BOTTOM);
        cell.setBorderColorBottom(RGBColor.BLACK);
        cell.setBorderWidthBottom(10f);
        cell.setBackgroundColor(RGBColor.GREEN);
        table.addCell(cell);
        ...
        cell.setBorderColorTop(RGBColor.BLUE);
        cell.setBackgroundColor(RGBColor.CYAN);
        table.addCell(cell);
        ...
        cell.setBorderColorLeft(RGBColor.RED);
        cell.setBorderColorBottom(RGBColor.ORANGE);
        cell.setBorderColorRight(RGBColor.YELLOW);
        cell.setBorderColorTop(RGBColor.GREEN);
        table.addCell(cell);
        ...
        cell.setBorderColor(RGBColor.RED);
        table.addCell(cell);
        document.add(table);
        document.close();
    }

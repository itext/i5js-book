...
public class HtmlMovies1XMLWorker {
	// TODO maybe move to a new part/chapter ?
    /** The resulting HTML file. */
    public static final String HTML = "results/part3/chapter09/movies_1_xmlworker.html";
    /** The resulting PDF file. */
    public static final String PDF = "results/part3/chapter09/html_movies_1_xmlworker.pdf";
    ...
    public static void main(final String[] args)
        ...
        new HtmlMovies1XMLWorker().createHtmlAndPdf(HTML, PDF);
    }
     ...
     * @throws DocumentException
     */
    public void createHtmlAndPdf(final String html, final String pdf)
...
//                    new StringReader(snippet), styles, providers);
            	...
            	XMLWorkerHelper xml = new XMLWorkerHelper();
            	xml.parseXHtml(new ElementHandler() {
     ...
     */
    public void setStyles(final StyleSheet styles) {
        this.styles = styles;
    }
     ...
     */
    public void setProviders(final HashMap<String, Object> providers) {
     ...
     */
    public String createHtmlSnippet(final Movie movie) {

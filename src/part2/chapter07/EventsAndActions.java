...
public class EventsAndActions {
    /** The resulting PDF. */
    public static final String RESULT = "results/part2/chapter07/events_and_actions.pdf";
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        new EventsAndActions().manipulatePdf(MovieTemplates.RESULT, RESULT);
    }
    ...
    public void manipulatePdf(String src, String dest) throws IOException, DocumentException {
        ...
        action = PdfAction.javaScript("app.alert('We hope you enjoy the festival');", writer);
        writer.setAdditionalAction(PdfWriter.DOCUMENT_CLOSE, action);
        action = PdfAction.javaScript("app.alert('This day is reserved for people with an accreditation or an invitation.');", writer);
        stamper.setPageAction(PdfWriter.PAGE_OPEN, action, 1);
        action = PdfAction.javaScript("app.alert('You can buy tickets for all the other days');", writer);

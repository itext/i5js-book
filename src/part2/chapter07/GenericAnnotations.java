...
public class GenericAnnotations extends PdfPageEventHelper {
    ...
    /** The resulting PDF. */
    public static final String RESULT = "results/part2/chapter07/generic_annotations.pdf";
    /** Possible icons */
    ...
    public void onGenericTag(PdfWriter writer, Document document,
        ...
        PdfAnnotation annotation = new PdfAnnotation(writer,
                new Rectangle(rect.getRight() + 10, rect.getBottom(), rect.getRight() + 30, rect.getTop()));
        ...
        annotation.put(PdfName.CONTENTS, new PdfString(String.format("Icon: %s", text)));
